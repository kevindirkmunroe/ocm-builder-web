...
+-----------+-------------+    | +------------------------+ |          |
  ...
  +---+---------+              |                            |
    ...
    function ensureRootIsScheduled(root) {
      ...
      if (ReactCurrentActQueue$3 && ReactCurrentActQueue$3.current !== null) {
      ...
      if (ReactCurrentActQueue$3 && ReactCurrentActQueue$3.isBatchingLegacy && root.tag === LegacyRoot) {
    ...
    function scheduleTaskForRootDuringMicrotask(root, currentTime) {
      ...
      if (includesSyncLane(nextLanes)) {
        ...
        if (
          ...
          // on the `act` queue.
          !(
            ReactCurrentActQueue$3 && ReactCurrentActQueue$3.current !== null &&
    ...
    function scheduleUpdateOnFiber(root, fiber, lane) {
      ...
      if (
        ...
        if (
          ...
          if (ReactCurrentActQueue && ReactCurrentActQueue.isBatchingLegacy);
          else {
    ...
    function batchedUpdates(fn, a) {
      ...
      try {
        ...
        if (
          ...
          ReactCurrentActQueue && !ReactCurrentActQueue.isBatchingLegacy
        ) {
          resetRenderTimer();
          flushSyncWorkOnLegacyRootsOnly();
        }
    ...
    function renderRootConcurrent(root, lanes) {
      ...
      outer: do {
        try {
          ...
          if (true && ReactCurrentActQueue && ReactCurrentActQueue.current !== null) {
    ...
    function scheduleCallback(priorityLevel, callback) {
      {
        ...
        var actQueue = ReactCurrentActQueue? ReactCurrentActQueue.current : null;
    ...
    function shouldForceFlushFallbacksInDEV() {
      ...
      return ReactCurrentActQueue && ReactCurrentActQueue.current !== null;
    }
    ...
    function warnIfUpdatesNotWrappedWithActDEV(fiber) {
      {
        ...
        if (ReactCurrentActQueue && ReactCurrentActQueue.current === null) {
          var previousFiber = current;
